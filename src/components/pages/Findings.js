  ...
  return (
    ...
    <main>
      ...
      <div className='body'>
        ...
        <img src='/research_website/images/A.jpg' className='graph'/>
        ...
        <img src='/research_website/images/B.jpg' className='graph'/>
        ...
        <img src='/research_website/images/C.jpg' className='graph'/>        
        <p className='imgfooter'>(Entrepreneurs’ reasons for starting a business)</p>
        <img src='/research_website/images/D.jpg' className='graph'/>
        ...
        <img src='/research_website/images/E.jpg' className='graph'/>
